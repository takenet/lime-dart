...
extension EnvelopeExtension on Envelope {
  ...
  Message toMessage(envelope) => toEnvelope(envelope, messageMediaType) as Message;
  Notification toNotification(envelope) => toEnvelope(envelope, notificationMediaType) as Notification;
  Command toCommand(envelope) => toEnvelope(envelope, commandMediaType) as Command;
